...
{
    public function index() { return Inertia::render('Stub', ['class' => 'NotificationController']); }
    public function show($id) { return Inertia::render('Stub', ['class' => 'NotificationController']); }
    public function create() { return Inertia::render('Stub', ['class' => 'NotificationController']); }
    public function store(Request $request) { return back()->with('success', 'Saved.'); }
    public function edit($id) { return Inertia::render('Stub', ['class' => 'NotificationController']); }
