...
{
    public function index() { return Inertia::render('Stub', ['class' => 'EarningsController']); }
    public function show($id) { return Inertia::render('Stub', ['class' => 'EarningsController']); }
    public function create() { return Inertia::render('Stub', ['class' => 'EarningsController']); }
    public function store(Request $request) { return back()->with('success', 'Saved.'); }
    public function edit($id) { return Inertia::render('Stub', ['class' => 'EarningsController']); }
