...
{
    public function index() { return Inertia::render('Stub', ['class' => 'AiController']); }
    public function show($id) { return Inertia::render('Stub', ['class' => 'AiController']); }
    public function create() { return Inertia::render('Stub', ['class' => 'AiController']); }
    public function store(Request $request) { return back()->with('success', 'Saved.'); }
    public function edit($id) { return Inertia::render('Stub', ['class' => 'AiController']); }
