...
{
    public function index() { return Inertia::render('Stub', ['class' => 'DashboardController']); }
    public function show($id) { return Inertia::render('Stub', ['class' => 'DashboardController']); }
    public function create() { return Inertia::render('Stub', ['class' => 'DashboardController']); }
    public function store(Request $request) { return back()->with('success', 'Saved.'); }
    public function edit($id) { return Inertia::render('Stub', ['class' => 'DashboardController']); }
