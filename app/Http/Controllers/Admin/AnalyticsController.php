...
{
    public function index() { return Inertia::render('Stub', ['class' => 'AnalyticsController']); }
    public function show($id) { return Inertia::render('Stub', ['class' => 'AnalyticsController']); }
    public function create() { return Inertia::render('Stub', ['class' => 'AnalyticsController']); }
    public function store(Request $request) { return back()->with('success', 'Saved.'); }
    public function edit($id) { return Inertia::render('Stub', ['class' => 'AnalyticsController']); }
